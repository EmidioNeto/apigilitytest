...
use Music\V1\Rest\Genero\GeneroEntity;

class GeneroResource extends AbstractResourceListener {
    ...
    public function __construct($db) {
        ...
        $resultSet->setArrayObjectPrototype(new GeneroEntity());
        $this->tableGateway = new TableGateway('genre', $db, null, $resultSet);
    }
    ...
    public function fetch($id) {
        ...
        $params = ['query' => '?genero='.$result->getName()];
